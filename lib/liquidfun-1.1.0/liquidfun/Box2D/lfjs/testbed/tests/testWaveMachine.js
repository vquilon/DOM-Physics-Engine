function TestWaveMachine() {
  ...
  var b1 = new b2EdgeShape();
  b1.Set(new b2Vec2(-2, -1), new b2Vec2(2, -1));
  body.CreateFixtureFromShape(b1, 0);

  var b2 = new b2EdgeShape();
  b2.Set(new b2Vec2(-2, 1), new b2Vec2(2, 1));
  body.CreateFixtureFromShape(b2, 0);

  var b3 = new b2EdgeShape();
  b3.Set(new b2Vec2(-2, 1), new b2Vec2(-2, -1));
  body.CreateFixtureFromShape(b3, 0);

  var b4 = new b2EdgeShape();
  b4.Set(new b2Vec2(2, 1), new b2Vec2(2, -1));
  body.CreateFixtureFromShape(b4, 0);
